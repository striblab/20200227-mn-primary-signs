...
```html
<div
  data-pym-src="https://static.startribune.com/news/projects/all/20200220-mnpoll-dem-primary/?pym=true"
>
  Loading...
</div>
<script
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20200220-mnpoll-dem-primary/",
      "url": "http://static.startribune.com/news/projects-staging/all/20200220-mnpoll-dem-primary/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20200220-mnpoll-dem-primary/",
      "url": "http://static.startribune.com/news/projects/all/20200220-mnpoll-dem-primary/"
    }
  }
}
```
